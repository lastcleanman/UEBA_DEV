...
from backend.core.config import CONFIG_FILE, LOG_DIR, CONF_DIR
from backend.core.utils import get_logger

logger = get_logger("AutoParserAI")
PARSER_DIR = os.path.join(CONF_DIR, "parsers")
...
def get_db_engine():
    try:
        ...
        with open(CONFIG_FILE, "r", encoding="utf-8") as f:
            config = json.load(f)
        # ueba_settings.json 내부의 DB 정보 읽기
